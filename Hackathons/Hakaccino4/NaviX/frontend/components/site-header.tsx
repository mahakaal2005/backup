...
import { MountainIcon, Moon, Sun, MessageSquarePlus } from 'lucide-react';
import { Button } from './ui/button';
import { useTheme } from 'next-themes';
import NavixLogo from './riskwise_logo4.png';
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background text-foreground">
      <div className="flex h-16 items-center justify-between mx-6">
        <Link href="/chat" className="flex items-center gap-2" prefetch={false}>
          <Image src={NavixLogo} alt="Navix Logo" className="w-10" />
          <span className="font-semibold text-primary">Navix</span>
        </Link>
